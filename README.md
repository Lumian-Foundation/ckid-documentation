...
The Cryptographic Key ID (CKID- pronounced “see kid”) is a new ID format that extends the concept of blockchain addresses to any object capable of generating and using a cryptographic private key, such as an IoT device or cloud server.  CKIDs have the following qualities:
